...
### Step 2: Installing Interactive Computing Environment (ICE)

Once Python is installed, the next step is to install a preferred ICE to start coding with Python. If you are a new user, we suggest using the **Jupyter Notebook**. 
